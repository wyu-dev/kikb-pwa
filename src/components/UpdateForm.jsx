...
function validate(form) {
  ...
  if (!form.berminatALK) errors.berminatALK = 'Sila pilih jawapan'
...
export default function UpdateForm({ member, onSubmit, isSubmitting }) {
  const [form, setForm] = useState({
    ...
    berminatALK: member.berminatALK || '',
  ...
  return (
    <div className="card p-6 mx-4 max-w-md w-full animate-slide-up">
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        {/* ── BAHAGIAN 3: MINAT ALK ── */}
        <div className="mb-6">
          <SectionTitle
            title="Minat Jawatan"
            icon={<svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.562.562 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z"/></svg>}
          />
          <Field label="Berminat Menjadi Ahli Lembaga Koperasi (ALK)?" required error={errs.berminatALK}>
            <div className="bg-white/5 rounded-xl px-4 py-3">
              <RadioGroup value={form.berminatALK} onChange={set('berminatALK')} options={['Ya', 'Tidak']} />
            </div>
          </Field>
        </div>

        {/* ── BAHAGIAN 4: MAKLUMAT BANK ── */}
        <div className="mb-6">
          <SectionTitle
            title="Maklumat Bank"
